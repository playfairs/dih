    ...
    VStack(alignment: .leading, spacing: 20) {
      ...
      HStack(spacing: 16) {
        ...
        VStack(alignment: .leading, spacing: 4) {
          ...
          Text(
            game.helperActive
              ? "Your hotline is generating points while you play."
              : "Call once to hire the hotline helper."
          )
      ...
      HStack(spacing: 20) {
        InfoTile(title: "HELPERS", value: "\(game.save.ownedHelpers)", icon: "person.2.fill")
        ...
        InfoTile(
          title: "RATE", value: "\(Int(Double(game.payoutAmount) * 60 / game.payoutInterval))/m",
          icon: "chart.line.uptrend.xyaxis")
        InfoTile(
          title: "LIFETIME", value: "\(game.save.passivePointsGenerated)",
          icon: "chart.line.uptrend.xyaxis")
      }
